...
def parse_args():
    ...
    parser.add_argument("--zero_shot", action='store_const', default=False, const=True)
    ...
    parser.add_argument('--geometric_p', type=int, default=0.2)
    ...
    parser.add_argument("--taskTopic", dest='task_topic', action='store_const', default=False, const=True)
